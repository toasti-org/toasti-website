  ...
  return (
    <footer className="flex h-fit w-full flex-none flex-col items-center gap-4 bg-custom-light-blue px-7 py-8 sm:flex-row sm:justify-between lg:px-10">
      <p className="text-center font-poppins-bold text-base text-custom-blue">
        2023 © Tim Olimpiade Astronomi Indonesia
      </p>
      <div className="flex flex-col items-center gap-6 sm:flex-row md:gap-16">
        {/* Privacy Policy */}
        <Link
          href="/kebijakan-privasi"
          className="text-center font-poppins-bold text-base text-custom-blue"
        >
          Kebijakan Privasi
        </Link>
