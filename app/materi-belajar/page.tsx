    ...
    <main className="flex-auto bg-custom-blue px-5 py-12 xl:py-16">
      <section className="flex flex-col items-center gap-12 xl:gap-16">
        {allStudyMaterials.map((section) => {
          return (
            <FramerOnScroll className="group" key={section.id}>
              <article className="flex max-w-xs flex-col items-center gap-6 sm:max-w-md sm:group-odd:items-start sm:group-even:items-end md:max-w-lg lg:max-w-xl xl:max-w-3xl xl:gap-8 2xl:max-w-4xl">
